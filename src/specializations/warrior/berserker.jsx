    ...
    >
      <defs>
        ...
        <g id='Berserker_flames'>
          ...
          <g clip-path='url(#Berserker_flame2_clip)'>
            <Rectangle
              fill={
                options.shading
                  ? 'url(#Berserker_flame2_shading)'
                  : props.palette.Flat
              }
            />
            <Show when={options.stroke}>
          ...
          <g clip-path='url(#Berserker_flame3_clip)'>
            <Rectangle
              fill={
                options.shading
                  ? 'url(#Berserker_flame3_shading)'
                  : props.palette.Flat
              }
            />
            <Show when={options.stroke}>
          ...
          <g clip-path='url(#Berserker_flame4_clip)'>
            <Rectangle
              fill={
                options.shading
                  ? 'url(#Berserker_flame4_shading)'
                  : props.palette.Flat
              }
            />
            <Show when={options.stroke}>
      ...
      <use href='#Berserker_flames' />
      <use href='#Berserker_flames' transform='translate(512) scale(-1 1)' />
      <g clip-path='url(#Berserker_sword_clip)'>
        <Rectangle
          fill={
            options.shading
              ? 'url(#Berserker_hilt_shading1)'
              : props.palette.Flat
          }
        />
        <Show when={options.shading}>
          <Rectangle fill='url(#Berserker_hilt_shading2)' width={256} />
          <Rectangle
            fill='url(#Berserker_blade_shading1)'
            x={204}
            width={104}
            height={359}
          />
          <Rectangle
            fill='url(#Berserker_blade_shading2)'
            x={204}
            width={52}
            height={359}
          />
    ...
    <Show when={options.tiny} fallback={<Normal />}>
      <Icon fill={props.palette.Flat}>
        <defs>
          <path
            id='Berserker_tiny'
            d='M9,11c-2-4,3-5,0-11,7,4,1,8,1,10v2l-1-1ZM6,0c2,5-3,6-3,10s6,6,7,9v-3c-1-2-4-3-4-6s3-4,1-9l-1-1ZM4,23v2s3-1,3-4c0-2-2-5-6-6,3,2,5,6,3,8ZM0,19c3.25,2.4375,2,6,5,7h2.5c-2.5-2-4.5-7-7.5-7Z'
          />
        </defs>
        <path d='M19,23.5l-2-.5v-3c0-4,2-7,2-7l-4-6-4,6s2,3,2,7v3l-2,.5-1-1.5h-1l1,4h1l2-.5,1,.5-.5,5.5,1.5.5,1.5-.5-.5-5.5,1-.5,2,.5h1l1-4h-1l-1,1.5Z' />
        <use href='#Berserker_tiny' />
        <use href='#Berserker_tiny' transform='translate(30) scale(-1 1)' />
      </Icon>
    </Show>
  );
};
