  ...
  const Normal = (
    ...
    >
      <defs>
        ...
        />
        <clipPath id='Ritualist_blade_clip'>
          <use href='#Ritualist_blade' />
        </clipPath>
        <clipPath id='Ritualist_handle_clip'>
          <use href='#Ritualist_handle' />
        </clipPath>
      </defs>
      ...
      <g clip-path='url(#Ritualist_blade_clip)'>
        <Rectangle
          fill={
            options.shading
              ? 'url(#Ritualist_blade_shading1)'
              : props.palette.Flat
          }
        />
        <Show when={options.shading}>
          <path
            fill='url(#Ritualist_blade_shading2)'
            d='M0,512V0l166.7,233.52c18.9772,1.2015,42.6734,20.1129,48.2557,38.3408l297.0443,240.1392'
          />
          <path
            fill='url(#Ritualist_blade_shading3)'
          ...
          />
          <path
            fill='url(#Ritualist_blade_shading4)'
      ...
      <g clip-path='url(#Ritualist_handle_clip)'>
        <Rectangle
          fill={
            options.shading
              ? 'url(#Ritualist_handle_shading)'
              : props.palette.Flat
          }
        />
        <Show when={options.stroke}>
  ...
  return (
    <Show when={options.tiny} fallback={<Normal />}>
      <Icon fill={props.palette.Flat}>
        <defs>
          <path
            id='Ritualist_tiny_mask'
            d='M16,9c2,2,1,6,1,6,0,0,4-1,6,1l9,9v7H0V0h7l9,9Z'
          />
          <clipPath id='Ritualist_tiny_clip'>
            <use href='#Ritualist_tiny_mask' />
          </clipPath>
        </defs>
        <path d='M24,15c1,1,3,4,0,6,3,0,5-3,4-5l-3-6,5-5c4-4-1-5-2-5-2,0-1,2-2,3l-4,4-6-3c-2-1-5,1-5,4,2-3,5-1,6,0,2,2,1.5,5.5,1.5,5.5,0,0,3.5-.5,5.5,1.5Z' />
        <path
          clip-path='url(#Ritualist_tiny_clip)'
          d='M16,8c0,4-6,6-6.5,6,0,0,.5,1,.5,3s-2,6-6,5c0,0-4,3-4,10,0,0,3-5,8-5,3,0,4.5.5,4.5.5,0,0,3.5-2.5,3.5-7.5,0,0,3-3,8-4'
        />
      </Icon>
    </Show>
  );
