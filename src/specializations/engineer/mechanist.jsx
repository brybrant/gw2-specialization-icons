  ...
  const Normal = (
    ...
    >
      <defs>
        ...
        />
        <circle id='Mechanist_head' cx={256} cy={218.4937} r={41.0316} />
        <clipPath id='Mechanist_shoulder_clip1'>
          <use href='#Mechanist_shoulder_stroke1' />
        </clipPath>
        <clipPath id='Mechanist_shoulder_clip2'>
          <use href='#Mechanist_shoulder_stroke2' />
        </clipPath>
        <clipPath id='Mechanist_arm_clip'>
          <use href='#Mechanist_arm' />
        </clipPath>
        <clipPath id='Mechanist_torso_clip'>
          <use href='#Mechanist_torso' />
        </clipPath>
        <clipPath id='Mechanist_head_clip'>
          <use href='#Mechanist_head' />
        </clipPath>
        <g
          id='Mechanist_shoulder_composite'
          clip-path='url(#Mechanist_shoulder_clip1)'
        >
          <Show when={options.stroke}>
            <Rectangle fill={props.palette.Dark} />
          </Show>
          <g clip-path='url(#Mechanist_shoulder_clip2)'>
            <Rectangle
              fill={
                options.shading
                  ? 'url(#Mechanist_shoulder_shading)'
                  : props.palette.Flat
              }
            />
            <Show when={options.stroke}>
              <g {...strokeWidth.x05} stroke={props.palette.Highlight}>
                <use {...strokeWidth.x1} href='#Mechanist_shoulder_stroke1' />
                <use href='#Mechanist_shoulder_stroke2' />
                <use
                  href='#Mechanist_shoulder_stroke1'
        ...
        <g id='Mechanist_arm_composite' clip-path='url(#Mechanist_arm_clip)'>
          <Rectangle
            fill={
              options.shading
                ? 'url(#Mechanist_arm_shading1)'
                : props.palette.Flat
            }
          />
          <Show when={options.shading}>
            <path
              ...
              fill='url(#Mechanist_arm_shading2)'
            />
          </Show>
          <Show when={options.stroke}>
            <use
      ...
      <use href='#Mechanist_shoulder_composite' />
      <use href='#Mechanist_arm_composite' />
      <g transform='translate(512) scale(-1 1)'>
        <use href='#Mechanist_shoulder_composite' />
        <use href='#Mechanist_arm_composite' />
      </g>
      <g clip-path='url(#Mechanist_torso_clip)'>
        <Rectangle
          fill={
            options.shading
              ? 'url(#Mechanist_torso_shading1)'
              : props.palette.Flat
          }
        />
        <Show when={options.shading}>
          <Rectangle fill='url(#Mechanist_torso_shading2)' width={256} />
          <path
            d='M500 133 256 313 12 133'
            fill='url(#Mechanist_torso_shading3)'
          />
        </Show>
        <Show when={options.stroke}>
          <use
            {...strokeWidth.x1}
            href='#Mechanist_torso'
            stroke={props.palette.Highlight}
          />
          <use
            {...strokeWidth.x05}
      ...
      <g clip-path='url(#Mechanist_head_clip)'>
        <Rectangle
          fill={
            options.shading
              ? 'url(#Mechanist_head_shading1)'
              : props.palette.Flat
          }
        />
        <Show when={options.shading}>
          <path
            ...
            fill='url(#Mechanist_head_shading2)'
          />
        </Show>
        <Show when={options.stroke}>
          <use
    ...
    <Show when={options.tiny} fallback={<Normal />}>
      <Icon fill={props.palette.Flat}>
        <defs>
          <path
            id='Mechanist_tiny'
            d='M10,7v9h-4v-5c0-3,2-4,4-4ZM10,6V1C4,1,0,5,0,11v5h5s0-5,0-5c0-4,3-5,5-5ZM10,17H0l3,14h4l2-5h-3c0-10,4-4,4-9Z'
          />
        </defs>
        <circle cx={16} cy={12.5} r={3.5} />
        <path d='M12,18c0-1,8-1,8,0,0,6-3,12-4,13-1-1-4-7-4-13Z' />
        <use href='#Mechanist_tiny' />
        <use href='#Mechanist_tiny' transform='translate(32) scale(-1 1)' />
      </Icon>
    </Show>
  );
};
