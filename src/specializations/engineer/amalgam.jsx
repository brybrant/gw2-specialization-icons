...
const AmalgamSwirl = (props) => {
  ...
  return (
    <g
      clip-path='url(#Amalgam_swirl_clip)'
      transform={props.rotation ? `rotate(${props.rotation} 256 256)` : null}
    >
      <Rectangle fill={options.shading ? props.shading1 : props.palette.Flat} />
  ...
  const Normal = (
    ...
    >
      <defs>
        ...
        />
        <circle id='Amalgam_circle' cx={256} cy={256} r={70.5207} />
        <clipPath id='Amalgam_swirl_clip'>
          <use href='#Amalgam_swirl' />
        </clipPath>
        <clipPath id='Amalgam_circle_clip'>
          <use href='#Amalgam_circle' />
        </clipPath>
      </defs>
      ...
      <AmalgamSwirl
        ...
        shading1='url(#Amalgam_swirl_shading1)'
        shading2='url(#Amalgam_swirl_shading2)'
        shading3='url(#Amalgam_swirl_shading3)'
      />
      <AmalgamSwirl
        palette={props.palette}
        rotation={180}
        shading1='url(#Amalgam_swirl_shading4)'
        shading2='url(#Amalgam_swirl_shading5)'
        shading3='url(#Amalgam_swirl_shading6)'
      />
      <g clip-path='url(#Amalgam_circle_clip)'>
        <Rectangle
          fill={
            options.shading
              ? 'url(#Amalgam_circle_shading)'
              : props.palette.Flat
          }
        />
        <Show when={options.stroke}>
  ...
  return (
    <Show when={options.tiny} fallback={<Normal />}>
      <Icon fill={props.palette.Flat}>
        <defs>
          <path
            id='Amalgam_tiny_swirl'
            d='M8,5C3,10,0,16,0,23c0,6.8484,6,11,16,4v-1C1,34-1,22,12,9c1-1-3-5-4-4Z'
          />
        </defs>
        <circle cx={16} cy={16} r={6} />
        <use href='#Amalgam_tiny_swirl' />
        <use href='#Amalgam_tiny_swirl' transform='rotate(180 16 16)' />
      </Icon>
    </Show>
  );
};
