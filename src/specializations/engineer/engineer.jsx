  ...
  const Normal = (
    ...
    >
      <defs>
        ...
        />
        <path
          id='Engineer_fuse_stroke'
          d='M264.5543,191.0917l-3.734-16.3505-9.6102-42.0812c-12.2363.9043-24.1242,3.0502-35.5541,6.2856-32.6232-34.0297,29.5085-77.4634,70.958-19.7241,53.8539,75.0185,123.4235.1324,75.7785-18.7785,18.9362,19.9742-22.0174,63.1471-58.4014,7.9536-54.3586-82.4604-163.9323-20.7889-122.6614,44.2416-10.4558,5.4904-20.3073,11.9758-29.4197,19.3418l17.8754,30.4725,26.7858,45.6623'
        />
        <Rectangle
          id='Engineer_shell'
          d='M264.6,419.61c-50.9217,0-93.6115-35.2154-105.0634-82.6192,17.3342,46.0653,61.7976,78.8429,113.9235,78.8429,11.177,0,21.9988-1.5148,32.2798-4.3365-12.6821,5.2244-26.5728,8.1128-41.1399,8.1128ZM267.98,222.5001c2.93-7.96,6.74-15.5,11.31-22.5,30.19,3.94,56.62,19.85,74.35,42.81-28.18-7.71-56.75-14.49-85.66-20.31Z'
        />
        <circle id='Engineer_shell_mask' cx={264.6} cy={311.52} r={136.83} />
        <path
          id='Engineer_shell_stroke1'
        ...
        />
        <path
          id='Engineer_shell_stroke2'
          d='M267.98,222.5001c2.93-7.96,6.74-15.5,11.31-22.5,30.19,3.94,56.62,19.85,74.35,42.81-28.18-7.71-56.75-14.49-85.66-20.31Z'
        />
        <clipPath id='Engineer_fuse_clip'>
          <use href='#Engineer_fuse' />
        </clipPath>
        <clipPath id='Engineer_shell_mask_clip'>
          <use href='#Engineer_shell_mask' />
        </clipPath>
      </defs>
      ...
      <g clip-path='url(#Engineer_fuse_clip)'>
        <Rectangle
          fill={
            options.shading ? 'url(#Engineer_fuse_shading)' : props.palette.Flat
          }
        />
        <Show when={options.stroke}>
          <g {...strokeWidth.x05} stroke={props.palette.Highlight}>
            <use {...strokeWidth.x1} href='#Engineer_fuse_stroke' />
            <use href='#Engineer_fuse' />
            <use href='#Engineer_fuse_stroke' stroke={props.palette.Dark} />
          </g>
        </Show>
      </g>
      <g clip-path='url(#Engineer_shell_mask_clip)'>
        <Show when={options.stroke}>
  ...
  return (
    <Show when={options.tiny} fallback={<Normal />}>
      <Icon fill={props.palette.Flat}>
        <defs>
          <Rectangle
            id='Engineer_tiny_mask1'
            d='M6,22c1,5,8,10,14,6-5,5-14,0-14-6ZM15,14l1-2c2,0,5,2,6,4-4-2-7-2-7-2Z'
            width={32}
            height={32}
          />
          <circle id='Engineer_tiny_mask2' cx={15} cy={21} r={15} />
          <clipPath id='Engineer_tiny_clip1'>
            <use href='#Engineer_tiny_mask1' />
          </clipPath>
          <clipPath id='Engineer_tiny_clip2'>
            <use href='#Engineer_tiny_mask2' />
          </clipPath>
        </defs>
        <circle clip-path='url(#Engineer_tiny_clip1)' cx={15} cy={21} r={11} />
        <path
          clip-path='url(#Engineer_tiny_clip2)'
          d='M15,4v7h-2c-2-2-6,0-7,1l-4-4'
        />
        <path d='M26,4c1,3-3,6-8,1-3-3-7-3-7,0,0,2,1,3,1,3l-3.5,1C7,8,6,0,13,0c3,0,4.4762,1.4762,6,3,2,2,5,5,7,1Z' />
      </Icon>
    </Show>
  );
};
