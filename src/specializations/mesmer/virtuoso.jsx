  ...
  const Normal = () => (
    ...
    >
      <defs>
        ...
        />
        <Rectangle
          id='Virtuoso_blade1_stroke2'
          d={ellipse(256, 211.5057, 27.1249)}
        />
        <path
          id='Virtuoso_blade2_stroke1'
        ...
        />
        <Rectangle
          id='Virtuoso_blade2_stroke2'
          d={ellipse(159.4239, 184.1084, 25.005)}
        />
        <clipPath id='Virtuoso_blade1_clip1'>
          <use href='#Virtuoso_blade1_stroke1' />
        </clipPath>
        <clipPath id='Virtuoso_blade1_clip2'>
          <use href='#Virtuoso_blade1_stroke2' />
        </clipPath>
        <clipPath id='Virtuoso_blade2_clip1'>
          <use href='#Virtuoso_blade2_stroke1' />
        </clipPath>
        <clipPath id='Virtuoso_blade2_clip2'>
          <use href='#Virtuoso_blade2_stroke2' />
        </clipPath>
        <g
          id='Virtuoso_blade2_composite'
          clip-path='url(#Virtuoso_blade2_clip1)'
        >
          <Show when={options.stroke}>
            <use
              {...strokeWidth.x05}
              href='#Virtuoso_blade2_stroke2'
              stroke={props.palette.Dark}
            />
          </Show>
          <g clip-path='url(#Virtuoso_blade2_clip2)'>
            <Rectangle
              fill={
                options.shading
                  ? 'url(#Virtuoso_blade2_shading1)'
                  : props.palette.Flat
              }
            />
            <Show when={options.shading}>
              <path
                ...
                fill='url(#Virtuoso_blade2_shading2)'
              />
              <circle
                cx={169.3689}
                cy={160.1005}
                fill='url(#Virtuoso_blade2_shading3)'
                r={85.907}
              />
            </Show>
            <Show when={options.stroke}>
      ...
      <g clip-path='url(#Virtuoso_blade1_clip1)'>
        <Show when={options.stroke}>
          <use
            {...strokeWidth.x05}
            href='#Virtuoso_blade1_stroke2'
            stroke={props.palette.Dark}
          />
        </Show>
        <g clip-path='url(#Virtuoso_blade1_clip2)'>
          <Rectangle
            fill={
              options.shading
                ? 'url(#Virtuoso_blade1_shading1)'
                : props.palette.Flat
            }
          />
          <Show when={options.shading}>
            <Rectangle fill='url(#Virtuoso_blade1_shading2)' width={256} />
            <circle
              cx={256}
              cy={166.501}
              fill='url(#Virtuoso_blade1_shading3)'
              r={113.8575}
            />
          </Show>
          <Show when={options.stroke}>
      ...
      <use href='#Virtuoso_blade2_composite' />
      <use
        href='#Virtuoso_blade2_composite'
  ...
  return (
    <Show when={options.tiny} fallback={<Normal />}>
      <Icon fill={props.palette.Flat}>
        <defs>
          <g id='Virtuoso_tiny'>
            <path d='M11.5,14h9s-1.5,9-4.5,15c-3-6-4.5-15-4.5-15Z' />
            <g fill='none' stroke={props.palette.Flat}>
              <circle cx={16} cy={10} r={3.5} stroke-width={2} />
              <path d='M16 1.5 16 7' stroke-width={3} />
            </g>
          </g>
        </defs>
        <path d='M11,15.5h10s-1,9.5-5,16.5c-4-7-5-16.5-5-16.5Z' />
        <g fill='none' stroke={props.palette.Flat}>
          <circle cx={16} cy={11.5} r={3.5} stroke-width={2} />
          <path d='M16 .5 16 8' stroke-width={3} />
        </g>
        <use href='#Virtuoso_tiny' transform='rotate(22.5 16 -12)' />
        <use href='#Virtuoso_tiny' transform='rotate(-22.5 16 -12)' />
      </Icon>
    </Show>
  );
