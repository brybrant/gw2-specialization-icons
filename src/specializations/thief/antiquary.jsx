  ...
  const Normal = (
    ...
    >
      <defs>
        ...
        />
        <clipPath id='Antiquary_card1_clip1'>
          <use href='#Antiquary_card1_stroke1' />
        </clipPath>
        <clipPath id='Antiquary_card1_clip2'>
          <use href='#Antiquary_card1_stroke2' />
        </clipPath>
        <clipPath id='Antiquary_card2_clip1'>
          <use href='#Antiquary_card2_stroke1' />
        </clipPath>
        <clipPath id='Antiquary_card2_clip2'>
          <use href='#Antiquary_card2_stroke2' />
        </clipPath>
        <g
          id='Antiquary_card2_composite'
          clip-path='url(#Antiquary_card2_clip1)'
        >
          <g clip-path={options.stroke ? null : 'url(#Antiquary_card2_clip2)'}>
            <Rectangle
              fill={
                options.shading
                  ? 'url(#Antiquary_card2_shading)'
                  : props.palette.Flat
              }
            />
      ...
      <use href='#Antiquary_card2_composite' />
      <use
        href='#Antiquary_card2_composite'
        transform='translate(512) scale(-1 1)'
      />
      <g clip-path='url(#Antiquary_card1_clip1)'>
        <Show when={options.stroke}>
          <Rectangle fill={props.palette.Dark} />
        </Show>
        <g clip-path='url(#Antiquary_card1_clip2)'>
          <Rectangle
            fill={
              options.shading
                ? 'url(#Antiquary_card1_shading)'
                : props.palette.Flat
            }
          />
          <Show when={options.stroke}>
            <g {...strokeWidth.x05} stroke={props.palette.Highlight}>
              <use {...strokeWidth.x1} href='#Antiquary_card1_stroke1' />
              <use
                href='#Antiquary_card1_stroke1'
                stroke={props.palette.Dark}
              />
              <use href='#Antiquary_card1_stroke2' />
            </g>
    ...
    <Show when={options.tiny} fallback={<Normal />}>
      <Icon fill={props.palette.Flat}>
        <defs>
          <path
            id='Antiquary_tiny'
            d='M5.5,29.5l8.5-2.5v-1h-6l-1-15.5c-4,.5-7,2.5-7,2.5l5.5,16.5Z'
          />
        </defs>
        <path d='M9,5l1,19h12l1-19c-4-1-10-1-14,0ZM16,19c-1-3-3-5-4-6,1-1,3-3,4-6,1,3,3,5,4,6-1,1-3,3-4,6Z' />
        <use href='#Antiquary_tiny' />
        <use href='#Antiquary_tiny' transform='translate(32) scale(-1 1)' />
      </Icon>
    </Show>
  );
};
