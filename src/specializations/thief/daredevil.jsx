...
export const Daredevil = (props) => {
  ...
  const Normal = () => (
    ...
    >
      <defs>
        <RadialGradient
          id='Daredevil_wing_back_shading'
          viewBox={[0, 0, 512, 512]}
          cx={209.3711}
          cy={103.9049}
          fx={170.5253}
        ...
        />
        <RadialGradient
          id='Daredevil_wing_front_shading'
          viewBox={[0, 0, 512, 512]}
          cx={278.4621}
          cy={136.2892}
          fx={202.8041}
        ...
        />
        <clipPath id='Daredevil_wing_back_clip'>
          <use href='#Daredevil_wing_back' />
        </clipPath>
        <clipPath id='Daredevil_boot_clip'>
          <use href='#Daredevil_boot' />
        </clipPath>
        <clipPath id='Daredevil_wing_front_clip'>
          <use href='#Daredevil_wing_front' />
        </clipPath>
      </defs>
      ...
      <g clip-path='url(#Daredevil_wing_back_clip)'>
        <Rectangle
          fill={
            options.shading
              ? 'url(#Daredevil_wing_back_shading)'
              : props.palette.Flat
          }
        />
      ...
      <g clip-path='url(#Daredevil_boot_clip)'>
        <Rectangle
          fill={
            options.shading
              ? 'url(#Daredevil_boot_shading)'
              : props.palette.Flat
          }
        />
        <Show when={options.stroke}>
      ...
      <g clip-path='url(#Daredevil_wing_front_clip)'>
        <Rectangle
          fill={
            options.shading
              ? 'url(#Daredevil_wing_front_shading)'
              : props.palette.Flat
          }
        />
        <Show when={options.stroke}>
  ...
  return (
    <Show when={options.tiny} fallback={<Normal />}>
      <Icon fill={props.palette.Flat}>
        <path d='M15,4l12-1-5,16,2,4c3,6,8,4,8,4v4s0,1-5,1c-4,0-8-3-8-3l-1,3-7-2,1-4,10,1v-3l-4-5,1-8-4-3v-4ZM8,12l7,6L1,11s0,4,8,8l8,4-10-2c1,2,3,3,13,4l-4-5,1-8L0,0c0,3,1,6,8,12Z' />
      </Icon>
    </Show>
  );
};
